...
type UserGORM struct {
	...
	ProfilePictureID *uuid.UUID     `gorm:"type:uuid;index"`                                                           // <-- DIUBAH
	ProfilePicture   MediaAssetGORM `gorm:"foreignKey:ProfilePictureID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL"` // <-- DITAMBAHKAN
